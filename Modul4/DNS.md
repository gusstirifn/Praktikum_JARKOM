...
![nslookup www.mit.edu](../assets/image/M4/nslookup%20www.mit.edu.png)
...
![nslookup -type=NS mit.edu](../assets/image/M4/nslookup%20-type=NS%20mit.edu.png)
...
![nslookup www.aiit.or.kr bitsy.mit.edu](../assets/image/M4/nslookup%20www.aiit.or.kr%20bitsy.mit.edu.png)
...
![soal 1](../assets/image/M4/soal1%20www.ntu.edu.sg.png)
...
![soal 2](../assets/image/M4/soal2%20nslookup%20-type=NS%20ox.ac.uk.png)
...
![soal 3](../assets/image/M4/soal3%20nslookup%20-type=MX%20yahoo.com%20ns1.ox.ac.uk.png)
...
![ipconfig /all](../assets/image/M4/ipconfig%20all.png)
...
![ipconfig /displaydns](../assets/image/M4/ipconfig%20displaydns.png)

- Perintah ipconfig /flushdns. Berfungsi untuk membersihkan cache DNS resolver.

![ipconfig /flushdns](../assets/image/M4/ipconfig%20flushdns.png)
...
![IPConfig](../assets/image/M4/IPConfig.PNG)
...
![kosongkan cache-nya](../assets/image/M4/clearchache.png)
...
![fillter ip wireshark](../assets/image/M4/wiresharkFilterIP.png)

- Dengan browser Anda, kunjungi halaman web: http://www.ietf.org
![web ietf](../assets/image/M4/web%20ietf.png)
...
![nslookup www.mit.edu](../assets/image/M4/nslookup%20www.mit.edu%20P3.png)

![dns](../assets/image/M4/dns%20P3.png)
...
![Type dan answers request](../assets/image/M4/Type%20dan%20answers%20request%20P4.png)
...
![3 jawaban](../assets/image/M4/3%20answer%20P5.png)
...
![alamat ip](../assets/image/M4/IP%20sesuai%20P6.png)
...
![DNS request](../assets/image/M4/P7%20.png)
...
![DNS REQUEST](../assets/image/M4/DNS%20REQUEST%20no1.png)

- DNS RESPONSE -> Source Port : 53

![DNS RESPONSE](../assets/image/M4/DNS%20RESPONSE%20no%201.png)
...
![alamat IP](../assets/image/M4/alamat%20IP%20no%202.png) 
...
![Tidak ada answer](../assets/image/M4/type%20answer%200%20no3%20.PNG)
...
![Type NS](../assets/image/M4/Type%20NS%20%203.2.png)
...
![server MIT](../assets/image/M4/server%20MIT%203.3.png)


### nslookup www.aiit.or.kr bitsy.mit.edu

![cmd www.aiit.or.kr bitsy.mit.edu](../assets/image/M4/4%20nslookup%20www.aiit.or.kr%20bitsy.mit.edu.png)

![wireshark www.aiit.or.kr bitsy.mit.edu](../assets/image/M4/4%20dns%20.png)

1.	Ke alamat IP manakah pesan permintaan DNS dikirimkan? Apakah alamat IP tersebut merupakan default alamat IP server DNS lokal Anda? 

- Pesan dikirim ke server bitsy.mit.edu, bukan ke DNS lokal.

![](../assets/image/M4/4.1%20server%20bitsy.mit.edu.png)

2.	Periksa pesan permintaan DNS. Apa ”jenis” atau ”type” dari pesan tersebut? Apakah pesan tersebut mengandung ”jawaban” atau ”answers”? 

- Jenis pesan adalah A dan tidak mengandung jawaban.

![type A](../assets/image/M4/4.2%20A%20dan%20tidak%20mengandung%20jawaban.png)
...
![timed out](../assets/image/M4/4.3%20timed%20out.png)
