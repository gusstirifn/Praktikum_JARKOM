...
![hypertext & Line-based Data 2](../assets/image/M3/hypertext&Line-basedData2.png)


### Retrieving Long Documents
7. Kembali ke browser dan buka link berikut, http://gaia.cs.umass.edu/wireshark-labs/HTTP-wireshark-file3.html.
![Open link 3](../assets/image/M3/openlink3.png)

8. Buka kembali wireshark dan ketik http pada pencarian. Perhatikan baris length info 200 ok (text/html),
   lalu lihat hypertext dan Line-based text datanya.
![hypertext & Line-based Data 3](../assets/image/M3/hypertext%20&%20Line-based%20Data%203.png)

![hypertext & Line-based Data 3.1](../assets/image/M3/line-based%20data%203.png)

![hypertext & Line-based Data 3.2](../assets/image/M3/line-based%20data%203.2.png)
...
![Open link 4](../assets/image/M3/openlink4.png)

10. Buka kembali wireshark dan ketik http pada pencarian. Perhatikan baris length info 200 ok (text/html),
   lalu lihat hypertext dan Line-based text datanya.
![hypertext & Line-based Data 4](../assets/image/M3/hypertext%20&%20Line-based%20Data%204.png)
...
![Open link 5](../assets/image/M3/openlink5.png)

12. Masukkan login dengan Username (wireshark-students) dan password (network).
![login](../assets/image/M3/login.png)

13. Login berhasil
![login berhasil](../assets/image/M3/berhasil%20login.png)

14. Buka kembali wireshark dan ketik http pada pencarian. Perhatikan baris length info 200 ok (text/html),
   lalu lihat hypertext dan Line-based text datanya.
![hypertext & Line-based Data 5](../assets/image/M3/hypertext%20&%20Line-based%20Data%205.png)
...
![close](../assets/image/M3/close.png)
